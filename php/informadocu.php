...
if ($accion == "documento"){
    ...
    $sql ="SELECT usuario.docu,nombres,apellidos,tipousu.nom_tip_usu,asignacion_t.ficha_trans,materias.nom_materia,detalform.no_ficha,formacion.nom_form from usuario LEFT JOIN tipousu on usuario.id_tip_usu=tipousu.id_tip_usu LEFT JOIN asignacion_t on asignacion_t.docu=usuario.docu LEFT JOIN detalform on detalform.docu=usuario.docu LEFT JOIN materias on asignacion_t.id_materia=materias.id_materia LEFT JOIN ambiente on detalform.id_amb = ambiente.id_amb LEFT JOIN formacion on ambiente.id_form=formacion.id_form where  usuario.nombres like '$documento%' and usuario.id_tip_usu in (3,4)";
    ...
    $sql ="SELECT usuario.docu,nombres,apellidos,tipousu.nom_tip_usu,asignacion_t.ficha_trans,materias.nom_materia,detalform.no_ficha,formacion.nom_form from usuario LEFT JOIN tipousu on usuario.id_tip_usu=tipousu.id_tip_usu LEFT JOIN asignacion_t on asignacion_t.docu=usuario.docu LEFT JOIN detalform on detalform.docu=usuario.docu LEFT JOIN materias on asignacion_t.id_materia=materias.id_materia LEFT JOIN ambiente on detalform.id_amb = ambiente.id_amb LEFT JOIN formacion on ambiente.id_form=formacion.id_form where detalform.no_ficha like '$documento%' and usuario.id_tip_usu in (3,4)";
